...
public class EndToEndTelecomFlow extends BaseClass {
	...
	public static String createNewCustomer(String firstname, String lastname, String email, String add, String mobile)
			throws InterruptedException {
		Thread.sleep(3000);
		WebElement addbtn = driver
				.findElement(By.xpath("(//div[@class='flex-item left'])/div/h3/a[text()='Add Customer']"));
	...
	@Test(priority = 4)
	public static void addTariffPlanToCustomer() throws InterruptedException {
		Thread.sleep(25000);
		WebElement approvedTariiffPlan = driver.findElement(By.xpath("//input[@id='sele']"));
		EndToEndTelecomFlow.verifyStatusAndClick(approvedTariiffPlan);
		Thread.sleep(5000);
		WebElement addTariffPlanToCustomer = driver.findElement(By.name("submit"));
		EndToEndTelecomFlow.verifyStatusAndClick(addTariffPlanToCustomer);

		Thread.sleep(4000);
		WebElement homeToClick = driver.findElement(By.xpath("(//a[text()='Home'])[1]"));
		EndToEndTelecomFlow.verifyStatusAndClick(homeToClick);

	}

	@Test(priority = 5)
	public static void payBilling() throws InterruptedException {
		Thread.sleep(4000);
		WebElement payBilling = driver.findElement(By.xpath("//a[text()='Pay Billing']"));
		EndToEndTelecomFlow.verifyStatusAndClick(payBilling);

		WebElement customID = driver.findElement(By.id("customer_id"));
		EndToEndTelecomFlow.verifyStatusAndEnterText(customID, cID);

		Thread.sleep(3000);
		WebElement payBillingsubmit = driver.findElement(By.xpath("//input[@name='submit']"));
		EndToEndTelecomFlow.verifyStatusAndClick(payBillingsubmit);
	}
